...
open class RtspServerFromFile : FromFileBase {
    ...
    constructor(
        ...
        openGlView, videoDecoderInterface,
    ...
    constructor(
        lightOpenGlView: LightOpenGlView, connectCheckerRtsp: ConnectCheckerRtsp, port: Int,
        videoDecoderInterface: VideoDecoderInterface,
        audioDecoderInterface: AudioDecoderInterface
    ) : super(
        lightOpenGlView, videoDecoderInterface,
        audioDecoderInterface
    ) {
        rtspServer = RtspServer(connectCheckerRtsp, port)
    }
    ...
    constructor(
        context: Context, connectCheckerRtsp: ConnectCheckerRtsp, port: Int,
        videoDecoderInterface: VideoDecoderInterface,
        audioDecoderInterface: AudioDecoderInterface
    ) : super(
        context, videoDecoderInterface,
        audioDecoderInterface
    ) {
        rtspServer = RtspServer(connectCheckerRtsp, port)
    }
