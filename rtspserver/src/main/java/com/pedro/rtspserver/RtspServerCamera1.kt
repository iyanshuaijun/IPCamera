 ...
 */
open class RtspServerCamera1 : Camera1Base, SurfaceHolder.Callback {

  private val rtspServer: RtspServer
  private var mCameraId: Int = 0

  constructor(surfaceView: SurfaceView, connectCheckerRtsp: ConnectCheckerRtsp, port: Int, cameraId: Int) : super(
    surfaceView) {
