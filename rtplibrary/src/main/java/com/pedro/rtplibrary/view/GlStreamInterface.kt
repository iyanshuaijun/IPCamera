        ...
        try {
            while (running) {
                if (frameAvailable || forceRender) {
                    ...
                    managerRender?.drawScreen(
                        encoderWidth, encoderHeight, false, 0, 0,
                        false, false
                    )
                    ...
                    synchronized(sync) {
                        ...
                        if (surfaceManagerEncoder.isReady && !limitFps) {
                            ...
                            managerRender?.drawScreenEncoder(
                                w, h, isPortrait, streamOrientation,
                                false, false
                            )
                        ...
                        if (surfaceManagerPreview.isReady && !limitFps) {
                            ...
                            managerRender?.drawScreenPreview(
                                w, h, isPortrait, true, 0, previewOrientation,
                                false, false
                            )
