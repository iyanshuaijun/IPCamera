 ...
 */
class UserControl(var type: Type = Type.PING_REQUEST, var event: Event = Event(-1, -1)) :
    ...
    override fun readBody(input: InputStream) {
        ...
        type = Type.values().find { it.mark.toInt() == t }
            ?: throw IOException("unknown user control type: $t")
        bodySize += 2
