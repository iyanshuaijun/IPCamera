...
import com.pedro.sample.ConnectCheckerRtp
...
class DisplayService : Service() {
  ...
  override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
    ...
    displayBase = RtspServerDisplay(baseContext, true, connectCheckerRtp, 4321)
  ...
  fun getPoint(): String? {
    ...
    return displayBase?.getEndPointConnection()
  }
}